...
<head>
    ...
    <link href="/resources/css/authors_page.css" rel="stylesheet">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <c:if test="${sessionScope.currentUser == null}">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/authorization">Вход</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/registration">Регистрация</a></li>
                        </ul>
                    </c:if>
                </li>
            </ul>
