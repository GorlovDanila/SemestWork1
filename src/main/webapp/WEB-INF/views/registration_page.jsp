...
<head>
    ...
    <link href="/resources/css/registration_page.css" rel="stylesheet">
    ...
    <div id="liveToast2" class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
        <div class="toast-header">
            ...
            <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Закрыть"
                    style="padding-left: 400px"></button>
        </div>
        <div class="toast-body">
            Вас перекинет на страницу авторизации, если пользователь с таким логином уже существует!
        </div>
    </div>
</div>
